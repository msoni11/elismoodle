 ...
 * this.parentuuid, current parent of the directory listing (RL EDIT)
...
YUI.add('moodle-core_filepicker', function(Y) {
    ...
    requires:['base', 'node', 'yui2-treeview', 'yui2-button', 'yui2-menu', 'yui2-cookie', 'yui2-layout', 'yui2-container', 'panel', 'cookie', 'datatable', 'datatable-sort'] // RL EDIT: BJB130215 - TBD: yui2-* ???
});
...
M.core_filepicker.init = function(Y, options) {
    ...
    Y.extend(FilePickerHelper, Y.Base, {
        ...
        request: function(args, redraw) {
            ...
            // RL EDIT: BJB130215 - send along the list of categories for filtering
            ...
            if (args.action == 'upload') {
                ...
                for(var k in params) {
                    ...
                    if(value instanceof Array) {
                        for(var i in value) {
                            // RL EDIT: BJB130215 - urlencode to prevent mangling of base64 encoded serialized "paths"
        ...
        process_existing_file: function(data) {
            ...
            var handleOverwrite = function(e) {
                ...
                this.request({
                    ...
                    'repository_id': data.duplicaterepo_id, // RL EDIT: BJB130215
       ...
       classnamecallback : function(node) {
        ...
        // RL EDIT: BJB130215 - Setter for the parent path attribute
        ...
        render: function() {
            ...
            // RL EDIT: BJB130215 - close the advanced search dialog when the file picker closes
        ...
        parse_repository_options: function(data, appendtolist) {
            ...
            // RL EDIT: BJB130215
            this.active_repo.refreshtooltip = data.refreshtooltip ? data.refreshtooltip : false; // this is true for ELIS files, so that the refresh icon has a tooltip
            this.active_repo.advancedsearch = data.advancedsearch ? data.advancedsearch : false; // this is true for ELIS Files, so that an advanced search button is added
            this.active_repo.executesearch = data.executesearch ? data.executesearch : false; // this is true for ELIS Files, so that a search button is added
            // End RL EDIT
            this.print_header();
        },
        ...
        display_response: function(id, obj, args) {
            ...
            scope.set_jumpto_state(scope.filepath); // RL EDIT: BJB130215
        },
        list: function(args) {
            if (!args) {
                args = {};
        ...
        create_upload_form: function(data) {
            ...
            var content = this.fpnode.one('.fp-content');
            var toelisfiles = (this.options.savepath.substr(0,1) != "/"); // RL EDIT: BJB130215
            ...
            content.one('.fp-upload-btn').on('click', function(e) {
                ...
                scope.request({
                        ...
                        repository_id: repo_id, // RL EDIT: BJB130215
        ...
        setup_toolbar: function() {
            ...
            // RL EDIT: BJB130215 - use the refactored "execute_search" method to perform the search
        ...
        print_header: function() {
            ...
            enable_tooltip(toolbar.one('.fp-tb-refresh'), r.refreshtooltip, M.str.repository.refresh); // search tooltip
            // End RL EDIT
            ...
            // RL EDIT: BJB130215
            // showing an advanced and execute search icons
            ...
            if (p && p.length!=0 && this.viewmode != 2) {
                for(var i = 0; i < p.length; i++) {
                    ...
                    el.on('click',
                            function(e, path) {
                                e.preventDefault();
                                this.refresh_content_and_jump_options([path]); // RL EDIT: BJB130215
                            },
                        this, p[i].path);
                }
